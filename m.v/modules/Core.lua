...
Fluent, SaveManager, InterfaceManager = assert(loadstring(game:HttpGet("https://raw.githubusercontent.com/conexion19/NexusLib-v.1.1.1-/refs/heads/main/gffff.lua")))()
...
if fs then
    SaveManager = assert(loadstring(game:HttpGet("https://raw.githubusercontent.com/conexion19/Save/refs/heads/main/SAVEGGLIBA.lua")))()
    InterfaceManager = assert(loadstring(game:HttpGet("https://raw.githubusercontent.com/conexion19/InterfaceManager-NEW-/refs/heads/main/InterfaceManager.lua")))()
end
