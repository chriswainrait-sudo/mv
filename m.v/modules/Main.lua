...
PrimeRuntime.toggleESPStones = toggleESPStones
PrimeRuntime.toggleESPBoxes = toggleESPBoxes
PrimeRuntime.toggleArtifactHolderESP = toggleArtifactHolderESP
...
TrackRuntimeCleanup(function() toggleAutomaticStoneCollection(false) end)
TrackRuntimeCleanup(function() toggleAutoCollect(false) end)
TrackRuntimeCleanup(function() toggleAutoFarm(false) end)
TrackRuntimeCleanup(function() toggleESPStones(false) end)
TrackRuntimeCleanup(function() toggleESPBoxes(false) end)
TrackRuntimeCleanup(function() toggleArtifactHolderESP(false) end)
